try {
	...
	(function(){
        ...
        jQuery('div#content').animate({'top' : '75px'});
				...
				jQuery('div#top').after('<div id="callout-container" style="background: url(/static/img/noise.png) repeat; 75px; top:0px; position: absolute; width:100%;"><div id="ios-callout" class="alert-positive new-item" style="margin: 10px 0px; font-size: 12px; text-align:center; top: 32px; position: relative; width: 100%;"><b>Introducing "Preview As."</b> See your site through the eyes of your visitors. <a>Learn more</a>.</div><div id="callout-close" style="position: absolute; float: right; font-size: 10px; right: 20px; bottom: -12px;">X</div></div>');
